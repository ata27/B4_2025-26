...
(d) A parcel of polluted boundary layer air containing PAN is transferred by convection to 5 km altitude where the ambient daytime temperature is 260 K. Assuming that J4 and the mixing ratio of O₃ are independent of altitude, calculate the chemical lifetime of PAN at 5 km.
